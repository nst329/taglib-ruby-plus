...
Then install taglib-ruby-plus 2.3.2.2:

    gem install taglib-ruby-plus --version 2.3.2.2
...
environment variable when installing, like this:
    ...
    TAGLIB_DIR=/opt/homebrew/opt/taglib gem install taglib-ruby-plus --version 2.3.2.2
