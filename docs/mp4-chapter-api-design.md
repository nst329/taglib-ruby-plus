...
| taglib-ruby-plus | 2.3.2.1（TagLib 2.3.2向けの派生リリース番号） |
| 初期対応OS | macOS、Linux |
...
- taglib-ruby-plusのバージョンは2.3.2.1とする。TagLib 2.3.2向けの派生リリース番号として、TagLibの要求バージョンとは別管理する。
...
- gemバージョンは`2.3.2.1`、TagLibの最低バージョンは`2.3.2`として別管理する。gemはRubyGemsの4要素バージョンで、TagLib 2.3.2向けの下流改訂を表す。
